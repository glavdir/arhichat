...
from app import app, queries, events_dialog, events_chat, api
from flask import render_template, session, request, make_response, send_file, json
from app import socketio
from app import revision
from app import shouts
import datetime
...
def dc(transport='websocket'):
    ...
    if not session['s_user'] or session['s_user']==0:
